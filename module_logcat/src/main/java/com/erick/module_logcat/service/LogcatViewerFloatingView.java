...
import com.erick.module_logcat.ILogcatViewerService;
import com.erick.module_logcat.R;
import com.erick.module_logcat.ui.StandOutWindow;
import com.erick.module_logcat.ui.Window;
import com.erick.module_logcat.ui.adapter.LogRecordsListAdapter;
import com.erick.module_logcat.ui.adapter.LogcatViewerListAdapter;
import com.erick.module_logcat.util.LogFileProviderUtil;
import com.erick.module_logcat.util.StandOutFlags;
...
public class LogcatViewerFloatingView extends StandOutWindow {
    ...
    public void createAndAttachView(int id, FrameLayout frame) {
        ...
        mMenuOptionLayout = rootView.findViewById(R.id.menuOptionsLayout);
        //Layout for "Enter filter text"
        mFilterLayout = rootView.findViewById(R.id.filterLayout);
        //Radio group containing different priority levels.
        mPriorityLevelRadioGroup = rootView.findViewById(R.id.rgPriorityLevels);
        //View for showing recorded logs.
        mRecordsListView = mMenuOptionLayout.findViewById(R.id.recordList);
        mRecordsListView.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);

        // Bottombar layouts
        mNormalBottombarLayout = rootView.findViewById(R.id.normalbottombar);
        mRecordsBottombarLayout = rootView.findViewById(R.id.recordsbottombar);
    ...
    private void setupBottomBarView(final View rootView) {
        ...
        rootView.findViewById(R.id.record).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    String logFilename = String.format(Locale.US, "log_%s.txt",
...
//      emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "sandeep@fatangare.info" });
        ...
        emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"jie.wu@cootek.cn"});
        ...
        for (int index = 0; index < cnt; index++) {
            if (checkedItemPositions.valueAt(index)) {
                ...
                uris.add(LogFileProviderUtil.getUri(getApplicationContext(), file));
            }
