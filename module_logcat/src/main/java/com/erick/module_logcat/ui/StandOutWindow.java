package com.erick.module_logcat.ui;
...
import com.erick.module_logcat.util.Utils;
...
public abstract class StandOutWindow extends Service {
    ...
    private static final String NOTIFY_CHANNEL_ID = "LOGCAT_VIEW";
    ...
    public Notification getPersistentNotification(int id) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            ...
            if (mNotificationManager != null) mNotificationManager.createNotificationChannel(channel);
            builder = new NotificationCompat.Builder(this, NOTIFY_CHANNEL_ID);
        }
        ...
        public StandOutLayoutParams(int id) {
            ...
            if (sdkInt < Build.VERSION_CODES.KITKAT) {
                ...
                if ("Xiaomi".equalsIgnoreCase(Build.MANUFACTURER)) {
                    ...
                    this.type = WindowManager.LayoutParams.TYPE_TOAST;
                }
